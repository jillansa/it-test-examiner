...
(select concat(o.descripcion,' ', o.anio) from tabOferta o where e.idOferta = o.id) as oferta, e.fecha_examen, c2.descripcion as cuerpo
FROM tabCuerpo c2
...
JOIN tabPreguntasClasificacion pc ON pc.idClasificacion = c.id
JOIN tabPreguntas p ON pc.idPregunta = p.id
LEFT JOIN tabExamen e ON p.idExamen = e.id
WHERE c2.id = " . $cursoCuerpo . " AND oc.activa = 'S'
